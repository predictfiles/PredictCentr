 ...
 * gradient) plus a solid-orange dot whose bottom edge sits level with the
 * bars' baseline (not centered on it). Geometry here is the source of
 * truth -- app/icon.png, app/apple-icon.png, and app/favicon.ico are
 * rasterized copies of this same shape (see scripts/generate-icons.ps1),
...
export function LogoMark({ size = 28, className }: { size?: number; className?: string }) {
  ...
  return (
    ...
    >
      ...
      <circle cx="80" cy="70" r="8" fill="#FF8A3D" />
    </svg>
  );
}
