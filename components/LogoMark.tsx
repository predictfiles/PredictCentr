 ...
 * gradient) plus an amber dot. Geometry here is the source of truth --
 * app/icon.png, app/apple-icon.png, and app/favicon.ico are rasterized
 * copies of this same shape (see scripts/generate-icons.ps1), so keep
...
export function LogoMark({ size = 28, className }: { size?: number; className?: string }) {
  ...
  return (
    ...
    >
      ...
      <circle cx="80" cy="78" r="8" fill="#FFC857" />
    </svg>
  );
}
